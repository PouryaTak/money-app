        ...
        <div className="relative">
            ...
            <div className="flex flex-col gap-2 w-full absolute top-0 bg-white px-8 pt-2 pb-5 rounded-b-[38px] z-10">
                <div className="w-full flex justify-between">
                    ...
                    <span className="text-red-400 text-sm font-bold block">- {numberSeparator(calcExpenses)}</span>
                </div>
                <hr className="border-dashed" />
                <div className="w-full flex justify-between">
                    <span className="font-bold text-sm text-green-400">{dictionary.general.incomes}</span>
                    <span className="text-green-400 text-sm font-bold block">+ {numberSeparator(calcIncomes)}</span>
                </div>
            </div>
        </div>
    )
